...
const initialCategories = [
  {
    ...
    items: [
      ...
      { id: 'r6', type: 'stad', text: '6 Nuenen', pdf: '/routes/6.pdf', map: 'https://goo.gl/maps/rinLtqdqrpNdFrHu6', videos: [{ label: 'Heenrit', url: 'https://youtu.be/-lxwwVMe5Bc?si=E4AHjMBHDAGT9-ck' }, { label: 'Terugrit', url: 'https://youtu.be/JgIIPRHSRpw?si=_g8pPDQFN_lHuth7' }] },
      { id: 'r7', type: 'stad', text: '7 Veldhoven MMC via Aalst', pdf: '/routes/7.pdf', map: 'https://goo.gl/maps/2wn2ri42YPjDRTkc7', videos: [{ label: 'Heenrit', url: 'https://youtu.be/-lxwwVMe5Bc?si=E4AHjMBHDAGT9-ck' }, { label: 'Terugrit', url: 'https://youtu.be/JgIIPRHSRpw?si=_g8pPDQFN_lHuth7' }] },
      { id: 'r8', type: 'stad', text: '8 Acht', pdf: '/routes/8.pdf', map: 'https://goo.gl/maps/KDJdAMPYmtCU793o6', videos: [{ label: 'Heenrit', url: 'https://youtu.be/-lxwwVMe5Bc?si=E4AHjMBHDAGT9-ck' }, { label: 'Terugrit', url: 'https://youtu.be/JgIIPRHSRpw?si=_g8pPDQFN_lHuth7' }] },
      { id: 'r10', type: 'stad', text: '10 Oirschot Kazerne', pdf: '/routes/10.pdf', map: 'https://goo.gl/maps/u1VCM98XLR4gibQy6', videos: [{ label: 'Heenrit', url: 'https://youtu.be/-lxwwVMe5Bc?si=E4AHjMBHDAGT9-ck' }, { label: 'Terugrit', url: 'https://youtu.be/JgIIPRHSRpw?si=_g8pPDQFN_lHuth7' }] },
      { id: 'r12', type: 'stad', text: '12 Gijzenrooi', pdf: '/routes/12.pdf', map: 'https://goo.gl/maps/pvcsGEmrZuyuidX3A', videos: [{ label: 'Heenrit', url: 'https://youtu.be/-lxwwVMe5Bc?si=E4AHjMBHDAGT9-ck' }, { label: 'Terugrit', url: 'https://youtu.be/JgIIPRHSRpw?si=_g8pPDQFN_lHuth7' }] },
      { id: 'r14', type: 'stad', text: '14 Veldhoven Zilverackers', pdf: '/routes/14.pdf', map: 'https://goo.gl/maps/b3rHcKpHwrB7sqR18', videos: [{ label: 'Heenrit', url: 'https://youtu.be/-lxwwVMe5Bc?si=E4AHjMBHDAGT9-ck' }, { label: 'Terugrit', url: 'https://youtu.be/JgIIPRHSRpw?si=_g8pPDQFN_lHuth7' }] },
      { id: 'r15', type: 'stad', text: '15 Veldhoven Abdijlaan', pdf: '/routes/15.pdf', map: 'https://goo.gl/maps/zT7RyaGGEfFwBFNA8', videos: [{ label: 'Heenrit', url: 'https://youtu.be/-lxwwVMe5Bc?si=E4AHjMBHDAGT9-ck' }, { label: 'Terugrit', url: 'https://youtu.be/JgIIPRHSRpw?si=_g8pPDQFN_lHuth7' }] },
      { id: 'r16', type: 'stad', text: '16 Veldhoven MMC', pdf: '/routes/16.pdf', map: 'https://goo.gl/maps/NB9B2serhaqnsz6b8', videos: [{ label: 'Heenrit', url: 'https://youtu.be/-lxwwVMe5Bc?si=E4AHjMBHDAGT9-ck' }, { label: 'Terugrit', url: 'https://youtu.be/JgIIPRHSRpw?si=_g8pPDQFN_lHuth7' }] },
      { id: 'r17', type: 'stad', text: '17 Roosten', pdf: '/routes/17.pdf', map: 'https://goo.gl/maps/ypypjG6zZmFaBKmA8', videos: [{ label: 'Heenrit', url: 'https://youtu.be/-lxwwVMe5Bc?si=E4AHjMBHDAGT9-ck' }, { label: 'Terugrit', url: 'https://youtu.be/JgIIPRHSRpw?si=_g8pPDQFN_lHuth7' }] },
      { id: 'r114', type: 'stad', text: '114 De Hurk', pdf: '/routes/114.pdf', map: 'https://goo.gl/maps/wNVDqY412Jo6KyMk7', videos: [{ label: 'Heenrit', url: 'https://youtu.be/-lxwwVMe5Bc?si=E4AHjMBHDAGT9-ck' }, { label: 'Terugrit', url: 'https://youtu.be/JgIIPRHSRpw?si=_g8pPDQFN_lHuth7' }] },
      { id: 'r119', type: 'stad', text: '119 ASML', pdf: '/routes/119.pdf', map: 'https://goo.gl/maps/BzQ61zRScuEGTxda7', videos: [{ label: 'Heenrit', url: 'https://youtu.be/-lxwwVMe5Bc?si=E4AHjMBHDAGT9-ck' }, { label: 'Terugrit', url: 'https://youtu.be/JgIIPRHSRpw?si=_g8pPDQFN_lHuth7' }] },
      { id: 'r324', type: 'stad', text: '324 Geldrop Coevering', pdf: '/routes/324.pdf', map: 'https://goo.gl/maps/qH9iWy8QDboPPUyk7', videos: [{ label: 'Heenrit', url: 'https://youtu.be/-lxwwVMe5Bc?si=E4AHjMBHDAGT9-ck' }, { label: 'Terugrit', url: 'https://youtu.be/JgIIPRHSRpw?si=_g8pPDQFN_lHuth7' }] },
      ...
      { id: 'r401', type: 'stad', text: '401 Airport', pdf: '/routes/401.pdf', map: 'https://goo.gl/maps/wZXxBwX7d1jpmdfQ6', videos: [{ label: 'Heenrit', url: 'https://youtu.be/-lxwwVMe5Bc?si=E4AHjMBHDAGT9-ck' }, { label: 'Terugrit', url: 'https://youtu.be/JgIIPRHSRpw?si=_g8pPDQFN_lHuth7' }] },
      { id: 'r402', type: 'stad', text: '402 Veldhoven Zonderwijk', pdf: '/routes/402.pdf', map: 'https://goo.gl/maps/AzkdnKNpGggagMym6', videos: [{ label: 'Heenrit', url: 'https://youtu.be/-lxwwVMe5Bc?si=E4AHjMBHDAGT9-ck' }, { label: 'Terugrit', url: 'https://youtu.be/JgIIPRHSRpw?si=_g8pPDQFN_lHuth7' }] },
      { id: 'r403', type: 'stad', text: '403 Veldhoven De Dom/Berg', pdf: '/routes/403.pdf', map: 'https://goo.gl/maps/t2tt2P7CTcL61hKa7', videos: [{ label: 'Heenrit', url: 'https://youtu.be/-lxwwVMe5Bc?si=E4AHjMBHDAGT9-ck' }, { label: 'Terugrit', url: 'https://youtu.be/JgIIPRHSRpw?si=_g8pPDQFN_lHuth7' }] },
      { id: 'r404', type: 'stad', text: '404 Nuenen Centrum', pdf: '/routes/404.pdf', map: 'https://goo.gl/maps/BnVdowtnS5JXrogm7', videos: [{ label: 'Heenrit', url: 'https://youtu.be/-lxwwVMe5Bc?si=E4AHjMBHDAGT9-ck' }, { label: 'Terugrit', url: 'https://youtu.be/JgIIPRHSRpw?si=_g8pPDQFN_lHuth7' }] },
      { id: 'r405', type: 'stad', text: '405 Achtse Barrier', pdf: '/routes/405.pdf', map: 'https://goo.gl/maps/MYakec5RN3dmyHKA9', videos: [{ label: 'Heenrit', url: 'https://youtu.be/-lxwwVMe5Bc?si=E4AHjMBHDAGT9-ck' }, { label: 'Terugrit', url: 'https://youtu.be/JgIIPRHSRpw?si=_g8pPDQFN_lHuth7' }] },
      { id: 'r406', type: 'stad', text: '406 Ekkersrijt', pdf: '/routes/406.pdf', map: 'https://goo.gl/maps/8ZBA4gaG6xzNEcck7', videos: [{ label: 'Heenrit', url: 'https://youtu.be/-lxwwVMe5Bc?si=E4AHjMBHDAGT9-ck' }, { label: 'Terugrit', url: 'https://youtu.be/JgIIPRHSRpw?si=_g8pPDQFN_lHuth7' }] },
      { id: 'r407', type: 'stad', text: '407 HTC (terug als 408)', pdf: '/routes/407.pdf', map: 'https://goo.gl/maps/kF7NkrEyib22hX8E7', videos: [{ label: 'Heenrit', url: 'https://youtu.be/-lxwwVMe5Bc?si=E4AHjMBHDAGT9-ck' }, { label: 'Terugrit', url: 'https://youtu.be/JgIIPRHSRpw?si=_g8pPDQFN_lHuth7' }] },
      { id: 'r408', type: 'stad', text: '408 HTC (terug als 407)', pdf: '/routes/408.pdf', map: 'https://goo.gl/maps/WDsWBvYGW1KhW8Rh9', videos: [{ label: 'Heenrit', url: 'https://youtu.be/-lxwwVMe5Bc?si=E4AHjMBHDAGT9-ck' }, { label: 'Terugrit', url: 'https://youtu.be/JgIIPRHSRpw?si=_g8pPDQFN_lHuth7' }] },
      ...
      { id: 'r20', type: 'streek', text: '20 Best NS - HTC', pdf: '/routes/20.pdf', map: 'https://goo.gl/maps/DzPyz1xXHau3Y2XQ9?g_st=ac' },
      { id: 'r23', type: 'streek', text: '23 Helmond - Boxmeer', pdf: '/routes/23.pdf', map: 'https://goo.gl/maps/pBPPvrjBJjB3d4N89?g_st=ac' },
      { id: 'r24', type: 'streek', text: '24 Eindhoven - Helmond via Geldrop', pdf: '/routes/24.pdf', map: 'https://goo.gl/maps/x8JAUt1SAJZcLfem7?g_st=ac' },
      { id: 'r25', type: 'streek', text: '25 Helmond - Gemert Pelgrimsrust', pdf: '/routes/25.pdf', map: 'https://goo.gl/maps/D5RWqdKkpQLaceaA8?g_st=ac' },
      { id: 'r26', type: 'streek', text: '26 Helmond - Gemert', pdf: '/routes/26.pdf', map: 'https://goo.gl/maps/33oHJptjDKoyeTV27?g_st=ac' },
      { id: 'r28', type: 'streek', text: '28 Deurne - Meijel', pdf: '/routes/28.pdf', map: 'https://goo.gl/maps/TqL7tE7qQh8vbjcT7?g_st=ac' },
      { id: 'r51', type: 'streek', text: '51 Helmond Eeuwsels', pdf: '/routes/51.pdf', map: 'https://goo.gl/maps/3NKXvMCmV92f4Bev8?g_st=ac' },
      { id: 'r52', type: 'streek', text: '52 Helmond Rijpelberg', pdf: '/routes/52.pdf', map: 'https://goo.gl/maps/7hPPB8ZNq6PHcM6b9?g_st=ac' },
      { id: 'r53', type: 'streek', text: '53 Helmond Straakven', pdf: '/routes/53.pdf', map: 'https://goo.gl/maps/sLirkmvixTATiw7V7?g_st=ac' },
      { id: 'r54', type: 'streek', text: '54 Helmond Brouwhuis', pdf: '/routes/54.pdf', map: 'https://goo.gl/maps/fRwZ4hcpxHcMbpHv6?g_st=ac' },
      { id: 'r55', type: 'streek', text: '55 Helmond Stiphout', pdf: '/routes/55.pdf', map: 'https://goo.gl/maps/NVuA2oQhG16v88669?g_st=ac' },
      { id: 'r120', type: 'streek', text: '120 Best NS - ASML gebouw 4', pdf: '/routes/120.pdf', map: 'https://goo.gl/maps/TxpRYt8Jxkhh2Fk17?g_st=ac' },
      { id: 'r123', type: 'streek', text: '123 Gemert Pelgrimsrust - Boxmeer', pdf: '/routes/123.pdf', map: 'https://goo.gl/maps/qWGwUtdUUNRXB5MD8?g_st=ac' },
      { id: 'r150', type: 'streek', text: '150 Helmond - Helmond \'t Hout', pdf: '/routes/150.pdf', map: 'https://goo.gl/maps/PpE8g8jfWTkNSWwS6?g_st=ac' },
      { id: 'r317', type: 'streek', text: '317 Eindhoven - Dommelen', pdf: '/routes/317.pdf', map: 'https://goo.gl/maps/6VGZqioQwPVqZta57?g_st=ac' },
      { id: 'r318', type: 'streek', text: '318 Eindhoven - Luyksgestel', pdf: '/routes/318.pdf', map: 'https://goo.gl/maps/vC9yVfv6rtfeETKy5?g_st=ac' },
      { id: 'r319', type: 'streek', text: '319 Eindhoven - Reusel', pdf: '/routes/319.pdf', map: 'https://goo.gl/maps/4JJ1icwuqNwCeUrh7?g_st=ac' },
      { id: 'r320', type: 'streek', text: '320 Eindhoven - Helmond via Asten', pdf: '/routes/320.pdf', map: 'https://goo.gl/maps/WSyXUrgdBGnSfnHk9?g_st=ac' },
      { id: 'r321', type: 'streek', text: '321 Eindhoven - Gemert Pelgrimsrust', pdf: '/routes/321.pdf', map: 'https://goo.gl/maps/di715Und6vygLtiQ7?g_st=ac' },
      { id: 'r322', type: 'streek', text: '322 Eindhoven - Uden', pdf: '/routes/322.pdf', map: 'https://goo.gl/maps/NNFGPAnn8Ai451H5A?g_st=ac' },
      { id: 'r323', type: 'streek', text: '323 Eindhoven - Gemert Groenesteeg', pdf: '/routes/323.pdf', map: 'https://goo.gl/maps/fsejfuTWoqRGbKe97?g_st=ac' }
    ]
  },
  {
    id: 'aanvang',
